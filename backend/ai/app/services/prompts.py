...
기본 응답 언어는 한국어입니다. 단, 입력(질문/문맥/대상 텍스트/선택 단어)의 주 언어가 명확하면 해당 언어로 응답하세요.
...
답변(answer)은 항상 한국어로 작성하세요.
고유명사, 인용구, 작품 내 원문 용어는 필요 시 원문 표기를 유지해도 됩니다.
...
추천 단어(word)는 target_block과 surrounding_blocks의 주 언어에 맞춰 제시하세요.
설명(description)은 항상 한국어로 작성하세요.
